...
const SHORTCUTS: Shortcut[] = [
  ...
  { label: "Watch", icon: "tv", color: "#06b6d4", href: "/watch" as Href },
  { label: "Events", icon: "calendar", color: "#ec4899", href: "/events" as Href },
  { label: "Live", icon: "radio", color: "#ef4444", href: "/live" as Href },
  { label: "Memories", icon: "time", color: "#8b5cf6", href: "/memories" as Href },
