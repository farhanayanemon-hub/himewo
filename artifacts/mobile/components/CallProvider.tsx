        ...
        <View style={{ alignItems: "center", gap: 14, marginTop: 80 }}>
          ...
          {state.phase === "active" && (
            <Text style={styles.note}>
              Live {video ? "video" : "audio"} streaming requires a native build.
            </Text>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  name: { color: "#fff", fontFamily: "Inter_700Bold", fontSize: 26 },
  status: { color: "#d1d5db", fontSize: 15 },
  note: { color: "#9ca3af", fontSize: 12, marginTop: 8, paddingHorizontal: 40, textAlign: "center" },
