...
import { Home, Users, Clapperboard, Bell, Heart, MessageCircle, Share2, MoreHorizontal, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-neutral-900 p-4 sm:p-8 font-sans selection:bg-indigo-100">
      ...
      <div className="relative w-full max-w-[390px] h-[844px] bg-slate-50 rounded-[48px] overflow-hidden shadow-2xl ring-[12px] ring-neutral-800 flex flex-col">
        ...
        {/* Feed Content */}
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5 pb-40 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
          {/* Post 1 */}
