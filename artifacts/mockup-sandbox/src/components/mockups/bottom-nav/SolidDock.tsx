      ...
      <div className="absolute bottom-0 w-full z-50 pointer-events-none flex flex-col">
        ...
        <div className="relative pointer-events-auto bg-white border-t border-slate-200/80 shadow-[0_-12px_40px_rgba(0,0,0,0.06)] h-[64px] flex items-end justify-between px-2 pb-[10px]">
          ...
          <button 
            ...
            className="flex-1 flex flex-col items-center justify-end group relative h-full"
          >
            <div className={`mb-1 relative flex flex-col items-center transform transition-all duration-200 active:scale-95 ${activeTab === 'Alerts' ? '-translate-y-1' : ''}`}>
              <div className="relative">
                <Bell className={`w-[26px] h-[26px] transition-colors duration-200 ${activeTab === 'Alerts' ? 'text-[#0055FF] stroke-[2.5px] fill-[#0055FF]/10' : 'text-slate-400 stroke-[2.5px] group-hover:text-slate-600'}`} />
            ...
            <span className={`text-[10px] tracking-wide leading-none transition-colors duration-200 ${activeTab === 'Alerts' ? 'font-bold text-[#0055FF]' : 'font-semibold text-slate-400 group-hover:text-slate-600'}`}>Alerts</span>
          </button>
