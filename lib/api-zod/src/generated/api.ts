...
export const GetCurrentUserResponse = zod.object({
  ...
  "viewerHasIncomingRequest": zod.boolean().nullish(),
  "viewerIncomingRequestId": zod.number().nullish(),
 ...
 */
export const DetectCountryResponse = zod.object({
...
export const syncProfileBodyFirstNameMax = 50;

export const syncProfileBodyLastNameMax = 50;

export const syncProfileBodyCountryMin = 2;
export const syncProfileBodyCountryMax = 2;
...
export const SyncProfileBody = zod.object({
  ...
  "firstName": zod.string().max(syncProfileBodyFirstNameMax).optional(),
  "lastName": zod.string().max(syncProfileBodyLastNameMax).optional(),
  "gender": zod.enum(['male', 'female']).optional(),
  "birthday": zod.string().optional(),
  "country": zod.string().min(syncProfileBodyCountryMin).max(syncProfileBodyCountryMax).optional()
})
 ...
 */
export const getFriendSuggestionsQueryLimitDefault = 10;

export const GetFriendSuggestionsQueryParams = zod.object({
  "mode": zod.enum(['pymk', 'onboarding']).optional().describe('\"onboarding\" returns a randomized batch preferring same-country profiles (for the post-signup flow); default is the ranked PYMK list.'),
  "limit": zod.coerce.number().default(getFriendSuggestionsQueryLimitDefault)
})
...
export const updateMyProfileBodyUsernameRegExp = new RegExp('^[a-z0-9](?:[a-z0-9._]*[a-z0-9])?$');
