// All countries: name, ISO 3166-1 alpha-2 code, dial code.
// Flag emoji is derived from the ISO code (regional indicator symbols).
// Single source of truth shared by the web and mobile signup flows.
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Puerto Rico", code: "PR", dialCode: "+1787" },
...
export const DEFAULT_COUNTRY: Country = findCountry("BD")!;
